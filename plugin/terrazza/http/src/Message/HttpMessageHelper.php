...
use Terrazza\Http\Stream\HttpStream;
use Terrazza\Http\Stream\HttpStreamInterface;
use Terrazza\Http\Stream\HttpStreamFactory;
...
trait HttpMessageHelper {
    ...
    public function getBody(): HttpStreamInterface {
        if ($this->stream) {
            ...
            return ($this->body instanceof HttpStreamInterface) ? $this->body : (new HttpStreamFactory)->createStream($this->body ?? "");
        }
    }
